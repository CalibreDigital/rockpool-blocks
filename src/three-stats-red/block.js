...
registerBlockType( 'sm/three-stats-red', {
    title: 'Three columns of stats (red)',
    icon: 'schedule',
    category: 'layout',
    attributes: {
        headline: {
    ...
    edit( { attributes, className, setAttributes } ) {
        const { headline, content, stat1, stat1Caption, stat2, stat2Caption, stat3, stat3Caption } = attributes;
        ...
        return (
					<div class="red-image-background">
            <aside>
              <div class="centred">
  	            <PlainText
